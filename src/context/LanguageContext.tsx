...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    // Hero
    'revolutionIsHere': 'Un Account Infiniti Servizi',
    'manageAllSubscriptions': 'Gestisci tutti i tuoi abbonamenti in un\'unica app: palestre, piscine, teatri, servizi digitali e molto altro. Scopri nuovi servizi nella tua zona e risparmia tempo e denaro.', 
    ...
    'whatIsText': 'Con **abbs**, puoi monitorare tutti i tuoi abbonamenti da un\'unica dashboard centralizzata, senza dover accedere a più siti o app. Visualizza costi mensili, scadenze e stato degli abbonamenti (attivo, in pausa, disattivato) in modo chiaro e immediato. Scopri nuovi servizi nella tua zona grazie alla mappa integrata e accedi a un marketplace in continua evoluzione. Ricevi notifiche personalizzate prima dei rinnovi e imposta avvisi per evitare addebiti indesiderati. L\intelligenza artificiale di ABBS analizza le tue abitudini di utilizzo e suggerisce alternative più adatte alle tue esigenze. Tieni tutto sotto controllo con statistiche aggiornate in tempo reale e accedi a promozioni riservate agli utenti della piattaforma.',
    
    // Mission
    'ourMission': 'La Nostra Missione',
    'missionDescription': 'Stiamo rivoluzionando il modo in cui gestisci i tuoi abbonamenti. Con abbs, organizzi tutti i servizi intorno a te in un\'unica app. Più ordine, più controllo, meno sprechi.',
    'abbsAdvantages': 'Vantaggi di abbs',
    'completeTracking': 'Tutti i tuoi abbonamenti in ordine.',
    ...
    'smartNotificationsDesc': 'Ricevi promemoria utili per evitare rinnovi indesiderati e gestire al meglio le tue spese.',
    'priceComparison': 'Confronto Prezzi',
    'priceComparisonDesc': 'Confronta le offerte disponibili e scegli quella più conveniente per te.',
    'documentManagement': 'Gestione Documenti',
    'documentManagementDesc': 'Organizza facilmente documenti e certificati medici.',
    ...
    'benefitsDesc': 'Scopri come abbs può semplificare la gestione quotidiana della tua attività.',
    'espandi': 'Espandi la tua clientela',
    'espandiDesc': 'Renditi visibile a migliaia di utenti tramite l\'app abbs. La tua attività viene inserita in un marketplace geolocalizzato dove chi cerca servizi come il tuo può scoprirli, provarli e abbonarsi con un clic. Il sistema di raccomandazione mostra i tuoi servizi agli utenti più in target, migliorando conversioni e riducendo i costi di acquisizione',
    ...
    'alwaysLooking': 'Siamo sempre alla ricerca di persone di talento per aiutarci a rivoluzionare **abbs**.',
    ...
    businessStep1Desc: "Hai già un gestionale? Non serve ripartire da zero. abbs importa automaticamente tutti i tuoi dati.",
    businessStep2: "Inizia in pochi secondi",
    businessStep2Desc: "Registrazione super veloce. Con email e password, tutto è pensato per essere semplice fin dal primo accesso.",
  ...
  en: {
    ...
    // Hero
    'revolutionIsHere': 'One Account Infinite Services',
    'manageAllSubscriptions': 'Manage all your subscriptions in one app: gyms, pools, theaters, digital services and much more. Discover new services in your area and save time and money.',
    'joinWaitingList': 'Join the waiting list',
    'learnMore': 'Learn More',
    'scrollToDiscover': 'Learn More',
    ...
    'whatIsText': 'With **abbs**, you can monitor all your subscriptions from a single centralized dashboard, without having to access multiple sites or apps. View monthly costs, deadlines and subscription status (active, paused, deactivated) clearly and immediately. Discover new services in your area thanks to the integrated map and access an ever-evolving marketplace. Receive personalized notifications before renewals and set alerts to avoid unwanted charges. ABBS artificial intelligence analyzes your usage habits and suggests alternatives better suited to your needs. Keep everything under control with real-time updated statistics and access promotions reserved for platform users.',
    
    // Mission
    'ourMission': 'Our Mission',
    'missionDescription': 'We\'re revolutionizing the way you manage your subscriptions. With abbs, you organize all the services around you in one app. More order, more control, less waste.',
    'abbsAdvantages': 'abbs Advantages',
    'completeTracking': 'All your subscriptions in order.',
    'completeTrackingDesc': 'Keep track of every active subscription, from Netflix to the gym down the street.',
    'smartNotifications': 'Smart Notifications',
    'smartNotificationsDesc': 'Receive useful reminders to avoid unwanted renewals and better manage your expenses.',
    'priceComparison': 'Price Comparison',
    'priceComparisonDesc': 'Compare available offers and choose the most convenient one for you.',
    'documentManagement': 'Document Management',
    'documentManagementDesc': 'Easily organize documents and medical certificates.',
    ...
    'benefitsDesc': 'Discover how abbs can simplify the daily management of your business.',
    'espandi': 'Expand your clientele',
    'espandiDesc': 'Make yourself visible to thousands of users through the abbs app. Your business is placed in a geolocated marketplace where those looking for services like yours can discover them, try them and subscribe with one click. The recommendation system shows your services to the most targeted users, improving conversions and reducing acquisition costs',
    'personalizzazione': 'Intelligent and automated management',
    'personalizzazioneDesc': 'With abbs you have a simple and complete dashboard to monitor every aspect of the business: bookings, preferences, bottlenecks in flow, performance. You can customize promotions, send targeted notifications and modify prices based on real customer behavior. Renewals activate themselves, invoices are generated automatically and every process is streamlined. Fewer manual operations, more time to focus on your work.',
    'automazione': 'Marketplace for your products',
    'automazioneDesc': 'Sell your products directly from the platform. Simplified management, payments included and dedicated visibility within the ABBS app.',
    'pricing': 'Integrated Artificial Intelligence',
    'pricingDesc': 'abbs integrates AI to analyze data, optimize prices, suggest targeted actions and simplify management. Every decision is data-driven, every process becomes more efficient.',
    'sicurezza': 'Security and data protection',
    'sicurezzaDesc': 'abbs protects your customers\' information with advanced systems and regulatory compliance. Data, payments and documents are safe, always.',
    
    // Footer
    'revolutionizeDigitalIdentity': 'Revolutionize your way of managing digital identity. One account, infinite services.',
    ...
    'questionsLearnMore': 'Have questions? Want to know more?',
    ...
    'alwaysLooking': 'We\'re always looking for talented people to help us revolutionize **abbs**.',
    ...
    'aquaFitness': 'Aqua Fitness Center',
    'cinemaRex': 'Rex Multiplex',
    'palazzoCongress': 'Congress Palace',
    'arenaConcert': 'Arena Concert Hall',
    'gymName': 'Olympia Gym',
    'centerSportive':'Elite Sports Center',
    ...
    // Service types
    'gym': 'Gym',
    'gymDesc': 'Complete monthly subscription with access to all available equipment and fitness classes. Includes changing rooms, showers and professional trainer support.',
    'pool': 'Pool',
    'poolDesc': 'Subscription for pool access with lanes and relaxation area. Includes group swimming lessons and access to saunas.',
    'cinema': 'Cinema',
    'cinemaDesc': 'Monthly cinema subscription with unlimited access to all screenings. Includes discount on snacks and drinks.',
    'course': 'Courses',
    'courseDesc': 'Subscription for training courses with access to educational material and final certificate.',
    'theater': 'Theater',
    'theaterDesc': 'Seasonal theater subscription with access to all season performances. Includes reserved seat and priority access.',
    'concert': 'Concert',
    'concertDesc': 'Seasonal subscription for concerts and musical events. Includes priority access and reserved area.',
    ...
    'freePremiumMonths':'3 free months of premium plan at launch',
    ...
    'november': 'November',
    'december': 'December',
    businessHeroTitle: "Simplify Your Business Management with abbs. The Intuitive Platform to Organize Customers, Revenue and Subscriptions",
    businessHeroSubtitle: "abbs is more than a simple management system: it's a tool designed to simplify the daily work of businesses. From customer management to revenue monitoring, to subscription control, everything is in one place — clear, accessible, customizable. Discover how to make every aspect of your business more efficient.",
    businessHeroCta1: "Contact us now",
    businessProblemsTitle: "Problems with subscription management? Let abbs solve them!",
    businessProblemsText: "Managing a business that offers subscriptions is complex: renewals, payments, cancellations, and resource management are just some of the daily challenges. abbs is the platform that optimizes these processes, reducing manual work and increasing revenue.",
    ...
    businessProblem3: "Difficulty monitoring key metrics: Without adequate tools, it's complicated to analyze data like churn rates, average customer value and other vital indicators",
    ...
    businessBenefitsText: "With abbs, you get a platform that not only manages your subscriptions but helps you optimize profits and improve operational efficiency intelligently and securely.",
    ...
    businessBenefit2: "Automate renewals, billing, and notifications, minimizing manual operations. With abbs, every step is simplified, reducing errors and saving precious time.",
    ...
    businessStep1Desc: "Do you already have a management system? No need to start from scratch. abbs automatically imports all your data.",
    businessStep2: "Start in seconds",
    businessStep2Desc: "Super fast registration. With email and password, everything is designed to be simple from the first access.",
    businessStep3: "Immediately Operational",
    businessStep3Desc: "Enjoy automatic subscription management, with the ability to customize offers and optimize revenue.",
    businessHowItWorksCta: "Contact us to learn more",
    ...
    businessFaq1Answer: "abbs offers a 30-day free trial. During the trial period, you can automatically import your data and test all features without modifying your operational flows. The transition is simple, fast and without manual entries: try ABBS, compare it and decide calmly.",
    businessFaq2: "How long does it take to start seeing benefits?",
    businessFaq2Answer: "Very little! With abbs you can start seeing the first benefits already in the first days: automatic import of subscriptions and data centralization allow you to save time immediately. Many of our customers notice smoother management and cost reduction within the first month.",
    businessFaq3: "How does abbs help me sell more?",
    businessFaq3Answer: "Through our app, users discover new subscriptions in their area, receive personalized promotions and smart notifications. You can create targeted offers, activate internal campaigns and appear among recommended proposals, increasing visibility and conversions naturally. It's like having a direct sales channel, already integrated into your potential customers' routine.",
    businessFaq4: "Is it safe to share our subscription data?",
    businessFaq4Answer: "The security of your data is our absolute priority. abbs uses bank-level encryption, is GDPR compliant and does not store sensitive information like passwords or complete credit card details. You can read our privacy policy for all the details.",
    businessFaq5: "How long does implementation take?",
    businessFaq5Answer: "Data transfer to the abbs management system takes 24-48 hours. Immediately you can start using the platform: the interface is simple, intuitive and fluid, designed to make you feel comfortable from the first access. In a few clicks you have everything under control — without the need for technical training.", 
    ...
    businessContactNamePlaceholder: "Enter your name",
    businessContactEmail: "Email",
    ...
    businessFinalCtaText: "Join the thousands of companies that are transforming subscription management into a competitive advantage.",
    businessFinalCtaButton: "Start Now with abbs",
    businessFinalCtaButton2: "Discover how abbs can improve your business",
    
    // Business page case studies
    'caseStudiesTitle': 'Platforms that revolutionized their sectors',
    'airbnbName': 'Airbnb',
